---
title: API Reference
description: Public API exported from @hitchsoftware/assistant-ui-tap.
---
...
[Trees & Re-renders](/tap/docs/tap/trees-and-rerenders#separate-scheduling-with-usetaproot).
