...
<Callout type="info">
Tap context is supported as of `@hitchsoftware/assistant-ui-tap` 0.9 and is no longer deprecated.
</Callout>
...
```ts
import { useContextProvider, useResource } from "@hitchsoftware/assistant-ui-tap";
