...
In January, we shipped 36 new versions of our package `@hitchsoftware/assistant-ui-react`. We also crossed 10k weekly downloads on npm for the first time. 🎉
...
## Styled components moved to @hitchsoftware/assistant-ui-react-ui

All styled components (Thread, ThreadList, AssistantModal, makeMarkdownText, etc.) have been moved to a new package, `@hitchsoftware/assistant-ui-ui`.
