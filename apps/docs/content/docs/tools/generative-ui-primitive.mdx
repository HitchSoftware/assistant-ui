...
The stock `@hitchsoftware/assistant-ui-ui` `Thread` switch returns `null` for unknown part types, including `generative-ui`. Add one of these patterns in **your** assistant message renderer.
