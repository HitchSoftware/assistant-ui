...
description: Build AI chat for iOS and Android with @hitchsoftware/assistant-ui-react-native — streaming, tools, attachments, and platform-native components from the same primitives as the web SDK.
---
...
<InstallCommand expo={["@hitchsoftware/assistant-ui-react-native", "@hitchsoftware/assistant-ui-react-ai-sdk"]} />
...
Create a backend API route using the Vercel AI SDK. This is the same endpoint you'd use with `@hitchsoftware/assistant-ui-react` on the web:
...
<Callout type="info">
  This is the same backend you'd use with `@hitchsoftware/assistant-ui-react` on the web. If you already have an API route, you can reuse it as-is.
</Callout>
...
import type { ThreadMessage } from "@hitchsoftware/assistant-ui-react-native";
import {
  View,
  Text,
  TextInput,
