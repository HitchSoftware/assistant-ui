...
```tsx
import { useAuiState } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { useAui } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { useAuiEvent } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { useLocalRuntime } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { useRemoteThreadListRuntime } from "@hitchsoftware/assistant-ui-react-native";
...
Add the [`@hitchsoftware/assistant-ui-metro`](https://www.npmjs.com/package/@hitchsoftware/assistant-ui-metro) plugin so Metro compiles the `"use generative"` directive:
...
```tsx
import { useAssistantDataUI } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { useAssistantInstructions } from "@hitchsoftware/assistant-ui-react-native";
...
import { defineToolkit, useInlineRender } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { makeAssistantDataUI } from "@hitchsoftware/assistant-ui-react-native";
...
These context providers are re-exported from `@hitchsoftware/assistant-ui-core/react` and are used internally by the primitives to scope the `aui` store to a particular item (message, part, thread list item, etc.). They are available for advanced custom rendering scenarios.
...
```tsx
import { MessageByIndexProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { PartByIndexProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { TextMessagePartProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { ChainOfThoughtByIndicesProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { ChainOfThoughtPartByIndexProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { ThreadListItemByIndexProvider } from "@hitchsoftware/assistant-ui-react-native";
...
```tsx
import { SuggestionByIndexProvider } from "@hitchsoftware/assistant-ui-react-native";
