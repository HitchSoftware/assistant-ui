...
`@hitchsoftware/assistant-ui-react-data-stream` consumes the data stream protocol, a standardized format for streaming AI responses. It is layered on `LocalRuntime` (see [architecture](/docs/runtimes/concepts/architecture)), so all `LocalRuntime` features apply.
...
<InstallCommand npm={["@hitchsoftware/assistant-ui-react", "@hitchsoftware/assistant-ui-react-data-stream"]} />

</Tab>
<Tab value="React Native">

<InstallCommand expo={["@hitchsoftware/assistant-ui-react-native", "@hitchsoftware/assistant-ui-react-data-stream"]} />

</Tab>
<Tab value="React Ink">

<InstallCommand npm={["@hitchsoftware/assistant-ui-react-ink", "@hitchsoftware/assistant-ui-react-data-stream", "ink", "react"]} />
...
```tsx
import { tool } from "@hitchsoftware/assistant-ui-react";
...
```tsx
import { toGenericMessages, toToolsJSONSchema } from "@hitchsoftware/assistant-stream";
...
```tsx
import { toLanguageModelMessages } from "@hitchsoftware/assistant-ui-react-data-stream";
...
```tsx
import { useCloudRuntime } from "@hitchsoftware/assistant-ui-react-data-stream";
...
For the full hook reference, see [`@hitchsoftware/assistant-ui-react-data-stream` API](/docs/api-reference/integrations/react-data-stream).
