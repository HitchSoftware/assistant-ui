...
<InstallCommand npm={["@hitchsoftware/assistant-ui-react"]} />
...
```tsx
import { useExternalMessageConverter } from "@hitchsoftware/assistant-ui-react";
...
import { createMessageQueue, useExternalStoreRuntime } from "@hitchsoftware/assistant-ui-react";
...
import { ThreadMessageLike } from "@hitchsoftware/assistant-ui-react";
...
import { useExternalStoreRuntime, AssistantRuntimeProvider } from "@hitchsoftware/assistant-ui-react";
...
import { useExternalStoreRuntime } from "@hitchsoftware/assistant-ui-react";
...
```tsx
import { getExternalStoreMessages, useAuiState } from "@hitchsoftware/assistant-ui-react";
