...
`@hitchsoftware/assistant-ui-react-langchain` wraps [`useStream`](https://reference.langchain.com/javascript/langchain-react/use-stream) from `@langchain/react` and exposes it as an assistant-ui runtime. It targets the same backend as [`@hitchsoftware/assistant-ui-react-langgraph`](/docs/runtimes/langgraph/overview) (LangGraph Cloud) but at a higher level, delegating stream plumbing to the upstream hook.
...
`@hitchsoftware/assistant-ui-react-langchain` is layered on `ExternalStoreRuntime` (see [architecture](/docs/runtimes/concepts/architecture)). Graph state is the source of truth; the runtime renders messages from `state.values.messages` and submits user input back to the graph.
...
<InstallCommand npm={["@hitchsoftware/assistant-ui-react", "@hitchsoftware/assistant-ui-react-langchain", "@langchain/react", "@langchain/langgraph-sdk"]} />

</Tab>
<Tab value="React Native">

<InstallCommand expo={["@hitchsoftware/assistant-ui-react-native", "@hitchsoftware/assistant-ui-react-langchain", "@langchain/react", "@langchain/langgraph-sdk"]} />

</Tab>
<Tab value="React Ink">

<InstallCommand npm={["@hitchsoftware/assistant-ui-react-ink", "@hitchsoftware/assistant-ui-react-langchain", "@langchain/react", "@langchain/langgraph-sdk", "ink", "react"]} />
...
```tsx title="components/MyAssistant.tsx"
import { Thread } from "@/components/assistant-ui/thread";
import { AssistantRuntimeProvider } from "@hitchsoftware/assistant-ui-react-native";
import { useStreamRuntime } from "@hitchsoftware/assistant-ui-react-langchain";
...
import { AssistantRuntimeProvider } from "@hitchsoftware/assistant-ui-react-ink";
import { useStreamRuntime } from "@hitchsoftware/assistant-ui-react-langchain";
...
import {
  ...
  useLangChainRespond,
} from "@hitchsoftware/assistant-ui-react-langchain";
...
```tsx
import { useLangChainToolCalls } from "@hitchsoftware/assistant-ui-react-langchain";
...
```tsx
import { useLangChainStream } from "@hitchsoftware/assistant-ui-react-langchain";
...
```tsx
import { useLangChainError } from "@hitchsoftware/assistant-ui-react-langchain";
...
```ts
import { convertLangChainBaseMessage } from "@hitchsoftware/assistant-ui-react-langchain";
```
