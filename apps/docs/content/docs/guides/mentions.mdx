...
```tsx
import { unstable_useMentionAdapter } from "@hitchsoftware/assistant-ui-react";
...
| **Dependencies** | None | `@hitchsoftware/assistant-ui-react-lexical`, `lexical`, `@lexical/react` |
...
```tsx
import { unstable_useTriggerPopoverScopeContext } from "@hitchsoftware/assistant-ui-react";
