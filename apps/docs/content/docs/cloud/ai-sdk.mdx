...
The `@hitchsoftware/assistant-ui-cloud-ai-sdk` package provides a single hook that adds full message and thread persistence to any [AI SDK](https://sdk.vercel.ai/) application:
...
<InstallCommand npm={["@hitchsoftware/assistant-ui-cloud-ai-sdk", "@ai-sdk/react", "ai"]} />

</Tab>
<Tab value="React Native">

<InstallCommand expo={["@hitchsoftware/assistant-ui-cloud-ai-sdk", "@ai-sdk/react", "ai", "assistant-cloud"]} />

</Tab>
<Tab value="React Ink">

<InstallCommand npm={["@hitchsoftware/assistant-ui-cloud-ai-sdk", "@ai-sdk/react", "ai", "assistant-cloud", "ink", "react"]} />
