...
<InstallCommand npm={["@hitchsoftware/assistant-ui-react", "@hitchsoftware/assistant-ui-react-langgraph"]} />

</Tab>
<Tab value="React Native">

<InstallCommand expo={["@hitchsoftware/assistant-ui-react-native", "@hitchsoftware/assistant-ui-react-langgraph", "assistant-cloud"]} />

</Tab>
<Tab value="React Ink">

<InstallCommand npm={["@hitchsoftware/assistant-ui-react-ink", "@hitchsoftware/assistant-ui-react-langgraph", "assistant-cloud", "ink", "react"]} />
...
import { LangChainMessage } from "@hitchsoftware/assistant-ui-react-langgraph";
...
```sh
npx shadcn@latest add @hitchsoftware/assistant-ui-thread-list
```
