...
Many primitives share their core logic with `@hitchsoftware/assistant-ui-react` via `@hitchsoftware/assistant-ui-core/react` — only the UI layer (Ink vs DOM) differs.

## Thread

```tsx
import { ThreadPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { AuiIf } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { LoadingPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { ComposerPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
Renders all queued composer items. Each item is wrapped in a `QueueItemByIndexProvider`, so `QueueItemPrimitive.*` can read item state and call queue actions inside the render prop. Backed by the shared `ComposerPrimitiveQueue` from `@hitchsoftware/assistant-ui-core/react`.
...
Conditional rendering based on composer state. Shared from `@hitchsoftware/assistant-ui-core/react`.
...
```tsx
import { MessagePartPrimitive, MessagePrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { AttachmentPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { QueueItemPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { ActionBarPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { BranchPickerPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { ThreadListPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { ThreadListItemPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
`Text` component displaying the thread list item title. Shared from `@hitchsoftware/assistant-ui-core/react`.
...
```tsx
import { SuggestionPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { ChainOfThoughtPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
Renders the individual parts of a chain of thought using a provided components map. Shared from `@hitchsoftware/assistant-ui-core/react`.
...
```tsx
import { ToolCallPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { DiffPrimitive, DiffView } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { StatusBarPrimitive } from "@hitchsoftware/assistant-ui-react-ink";
```
...
```tsx
import { TextInput } from "@hitchsoftware/assistant-ui-react-ink";
```
