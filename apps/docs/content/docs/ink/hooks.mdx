...
```tsx
import { useAuiState } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useAui } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useAuiEvent } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useNotification } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useLocalRuntime } from "@hitchsoftware/assistant-ui-react-ink";
...
| `cloud` | `AssistantCloud` | Cloud instance for thread persistence via `@hitchsoftware/assistant-ui-cloud` |
...
```tsx
import { useRemoteThreadListRuntime, useLocalRuntime } from "@hitchsoftware/assistant-ui-react-ink";
...
<Callout type="info">
  ...
  `@hitchsoftware/assistant-ui-react-ink` runs at runtime: import it as a value, with no
  `"use generative"` directive and no `"use client"` inside `execute`.
</Callout>

```tsx title="weather-toolkit.tsx"
import { defineToolkit } from "@hitchsoftware/assistant-ui-react-ink";
...
import { AuiConfig, AuiProvider, Tools, useAui } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useAssistantInstructions } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { useAssistantDataUI } from "@hitchsoftware/assistant-ui-react-ink";
import { Text } from "ink";
...
```tsx
import { makeAssistantDataUI } from "@hitchsoftware/assistant-ui-react-ink";
import { Text } from "ink";
...
```tsx title="weather-toolkit.tsx"
import { defineToolkit, useInlineRender } from "@hitchsoftware/assistant-ui-react-ink";
import { Text } from "ink";
...
```tsx
import { AssistantRuntimeProvider, useLocalRuntime } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { MessageByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { PartByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { TextMessagePartProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { ChainOfThoughtByIndicesProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { ChainOfThoughtPartByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { SuggestionByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { ThreadListItemByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { ThreadListItemRuntimeProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { MessageAttachmentByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
...
```tsx
import { ComposerAttachmentByIndexProvider } from "@hitchsoftware/assistant-ui-react-ink";
