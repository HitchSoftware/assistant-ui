...
```diff
-import { TextContentPart, useContentPart, ToolCallContentPartComponent } from "@hitchsoftware/assistant-ui-react";
+import { TextMessagePart, useMessagePart, ToolCallMessagePartComponent } from "@hitchsoftware/assistant-ui-react";
```
