...
```tsx
// iframe.tsx
import { AssistantFrameProvider } from "@hitchsoftware/assistant-ui-react";
import { ModelContextRegistry } from "@hitchsoftware/assistant-ui-react";
import { z } from "zod";
...
```tsx
// parent.tsx
import { useAssistantFrameHost } from "@hitchsoftware/assistant-ui-react";
