...
This page covers the **AI SDK** path. If you use [`@hitchsoftware/assistant-ui-react-langgraph`](/docs/runtimes/langgraph/overview), tracing flows through LangGraph Cloud automatically; you only need this guide when your route handler talks to AI SDK directly.
