...
`@hitchsoftware/assistant-ui-mcp-docs-server` provides direct access to assistant-ui documentation and examples in your IDE via the Model Context Protocol.
...
```bash
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server
```

Or specify your IDE directly:

```bash
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a claude-code
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a claude-desktop
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a codex
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a cursor
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a gemini-cli
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a opencode
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a vscode
npx add-mcp @hitchsoftware/assistant-ui-mcp-docs-server -a zed
```
