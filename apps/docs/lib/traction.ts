...
export const PACKAGES: PackageInfo[] = [
  ...
  {
    name: "@hitchsoftware/assistant-ui-store",
    description: "Tap-based state management.",
    category: "core",
  },
  {
    name: "@hitchsoftware/assistant-ui-tap",
  ...
  {
    name: "@hitchsoftware/assistant-ui-cloud-ai-sdk",
  ...
  {
    name: "@hitchsoftware/assistant-ui-eve",
    description: "Eve runtime adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-langgraph",
    description: "LangGraph adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-langchain",
    description: "LangChain useStream adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-google-adk",
    description: "Google ADK adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-opencode",
    description: "OpenCode runtime adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-pi",
    description: "Pi coding-agent runtime adapter.",
    category: "frameworks",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-a2a",
    description: "A2A v1.0 agent-to-agent protocol adapter.",
    category: "protocols",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-ag-ui",
    description: "AG-UI protocol adapter.",
    category: "protocols",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-data-stream",
    description: "Generic data stream adapter.",
    category: "protocols",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-native",
    description: "React Native bindings.",
    category: "platforms",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-ink",
    description: "Terminal UI bindings via Ink.",
    category: "platforms",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-markdown",
    description: "Streaming-aware markdown renderer.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-streamdown",
    description: "Streamdown-based markdown rendering.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-syntax-highlighter",
    description: "Syntax highlighting for assistant-ui.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-ink-markdown",
    description: "Markdown for the terminal distribution.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-lexical",
    description: "Lexical composer with @-mention support.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-hook-form",
    description: "React Hook Form integration.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-generative-ui",
    description: "Render model-authored component trees.",
    category: "ui",
  },
  {
    name: "@hitchsoftware/assistant-ui-react-devtools",
