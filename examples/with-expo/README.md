...
The chat is powered by `@hitchsoftware/assistant-ui-react-native` with the AI SDK runtime (`@hitchsoftware/assistant-ui-react-ai-sdk`). The example leans on native Expo APIs throughout:
