...
- [#4244](https://github.com/assistant-ui/assistant-ui/pull/4244) [`615a218`](https://github.com/assistant-ui/assistant-ui/commit/615a2185979648e404202e825cc43efb80cde2c4) - feat: add `@hitchsoftware/assistant-ui-metro` — the `"use generative"` directive compiler for Expo / React Native, so RN apps author tools with the same `defineToolkit` API as the web via `withAui` in `metro.config.js` ([@Yonom](https://github.com/Yonom))
